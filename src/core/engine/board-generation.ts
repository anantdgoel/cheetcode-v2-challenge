import type { BillingMode, BoardProfile, FinalShiftKind, LineFamily, RouteCode, Urgency } from '@/core/domain/game'
import {
  BILLING_MODES,
  BOARD_PROFILES,
  GENERIC_LABELS,
...
function getCompatibilityBaseline (family: LineFamily, routeCode: RouteCode, billingMode: BillingMode, urgency: Urgency) {
  const key: CompatibilityKey = `${routeCode}|${billingMode}|${urgency}`
